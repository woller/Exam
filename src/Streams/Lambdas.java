...
public class Lambdas
{
    ...
    {
        Predicate<String> stringLength = (s) -> s.length() > 3; //metoden/kodestumpen her erstatter predicate's .test()
        ...
        BinaryOperator<Double> doubleAdder = (doubleOne, doubleTwo) -> doubleOne + doubleTwo;
